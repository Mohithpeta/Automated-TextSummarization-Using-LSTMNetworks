...
import asyncio  # Needed for handling async functions

@app.route('/summary', methods=['GET', 'POST'])
def summary():
    word_count = 0
    translated_text = ""  # Initialize translated_text before usage
    pronunciation = ""  # Initialize pronunciation before usage
    ...
    if request.method == 'POST':
        ...
        return render_template('summary.html', 
                                ...
                                )  # Make sure translated_text and pronunciation are always passed to the template
